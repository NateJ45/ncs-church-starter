#!/usr/bin/env node
// PORTED from ncs-astro-sanity-starter (2026-08-27). NOT a canonical copy: the
// parity harness is a PATTERN, not a byte-identical file. Each repo's normalizer
// grows its own rules (WCP added Instagram-embed rules; a site with a third-party
// widget will need more), so this file deliberately carries no PORTABLE marker
// and sync-check.mjs does not police it. Re-read the starter's copy before
// making a structural change here, and port real fixes back by hand.
/**
