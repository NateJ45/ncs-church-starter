...
// or when any shared / non-`page` doc changes (staff, ministries, events,
// sermons, FAQ items, site settings... all can appear on any page), but stay
// silent for edits to some OTHER custom page.
//
...
export const GET: APIRoute = async ({ cookies, url }) => {
  ...
  upstream.searchParams.set('tag', 'church-starter.preview-live');
