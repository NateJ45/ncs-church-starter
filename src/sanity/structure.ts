        ...
        .child(
          S.list()
            ...
            .items([
              ...
              // page's publish menu ("Save a section as preset..."), put on
              // another page from the saved section's own publish menu ("Add to
              // a page..."). Ordered by name, because the name is the only way
              // you find one again.
